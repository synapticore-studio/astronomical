...
def create_emission_node_group():
    ...
    interface.new_socket(name="Use Blackbody", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_advanced_emission_node_group():
    ...
    interface.new_socket(name="Emission Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Temperature", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Glow Radius", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Fresnel Mix", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_emission_material(name: str, preset: str = "star_core") -> bpy.types.Material:
    """
