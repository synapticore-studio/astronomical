...
def create_stellar_blackbody_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Temperature", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Luminosity", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Stellar Class", in_out='INPUT', socket_type='NodeSocketString')
    interface.new_socket(name="Emission Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Corona Intensity", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    color_ramp.color_ramp.elements[1].color = (0.7, 0.8, 1.0, 1.0)  # Heiße Sterne (blau)
    
    # Math Node für Temperatur-Normalisierung
    temp_normalize = ng.nodes.new("ShaderNodeMath")
    temp_normalize.operation = 'DIVIDE'
    temp_normalize.inputs[1].default_value = 40000.0  # Max Temperatur für Normalisierung
    ...
    ng.links.new(input_node.outputs["Corona Intensity"], corona_emission.inputs["Strength"])
...
def create_stellar_classification_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Spectral Class", in_out='INPUT', socket_type='NodeSocketString')
    interface.new_socket(name="Custom Temperature", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Custom Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    # Verbindungen
    ng.links.new(input_node.outputs["Custom Temperature"], blackbody.inputs["Temperature"])
