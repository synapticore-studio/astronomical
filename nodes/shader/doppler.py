...
def create_doppler_effect_node_group():
    ...
    interface.new_socket(name="Rest Wavelength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Emission Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Doppler Intensity", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_redshift_visualization_node_group():
    ...
    interface.new_socket(name="Emission Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Distance Dimming", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_doppler_material(name: str, preset: str = "approaching_star") -> bpy.types.Material:
    """
