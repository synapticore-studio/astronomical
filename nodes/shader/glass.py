...
def create_glass_node_group():
    ...
    interface.new_socket(name="Absorption Density", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    ng.links.new(input_node.outputs["Absorption Density"], volume_absorption.inputs["Density"])
...
def create_crystal_node_group():
    ...
    # Input sockets
    interface.new_socket(name="Base Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Crystal Faces", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Refraction", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Dispersion", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Internal Glow", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_glass_material(name: str, preset: str = "optical_glass") -> bpy.types.Material:
    """
