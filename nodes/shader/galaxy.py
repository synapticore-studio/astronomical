...
def create_galaxy_disk_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Color Index", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Star Formation Rate", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Metallicity", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Age", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Dust Extinction", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Spiral Arm Contrast", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    ng.links.new(input_node.outputs["Star Formation Rate"], emission_young.inputs["Strength"])
...
def create_galaxy_bulge_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Bulge Mass", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Metallicity", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Age", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Central Velocity Dispersion", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_galaxy_halo_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Halo Mass", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Halo Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Halo Intensity", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Halo Size", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_galaxy_composite_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Galaxy Type", in_out='INPUT', socket_type='NodeSocketString')
    interface.new_socket(name="Stellar Mass", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Bulge to Disk Ratio", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Star Formation Rate", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Metallicity", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Age", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Dust Extinction", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    # Verbindungen - Disk
    ng.links.new(input_node.outputs["Star Formation Rate"], disk_group.inputs["Star Formation Rate"])
    ...
    ng.links.new(input_node.outputs["Dust Extinction"], disk_group.inputs["Dust Extinction"])
    ...
    # Shader mixing
    ng.links.new(input_node.outputs["Bulge to Disk Ratio"], mix_disk_bulge.inputs["Fac"])
