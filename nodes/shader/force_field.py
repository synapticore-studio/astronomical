...
class AlbpyForceFieldShaderGroup(bpy.types.ShaderNodeGroup):
    bl_idname = "ALBPY_NG_ForceField"
    bl_label = "Albpy Force Field Shader Group"
    ...
    def init(self, context):
        ...
        self.inputs.new("NodeSocketFloat", "Field Strength")
        self.inputs.new("NodeSocketFloat", "Ripple Speed")
        ...
        # Set default values
        self.inputs["Color"].default_value = (0.8, 0.2, 1.0, 1.0)
        self.inputs["Field Strength"].default_value = 1.5
        self.inputs["Ripple Speed"].default_value = 2.0
        self.inputs["Transparency"].default_value = 0.6
        ...
        self.links.new(self.inputs["Field Strength"], emission.inputs["Strength"])
        self.links.new(self.inputs["Ripple Speed"], wave.inputs["Scale"])
