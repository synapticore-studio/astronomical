...
def create_redshift_node_group():
    ...
    interface.new_socket(name="Distance Factor", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Cosmological Dimming", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    redshift_ramp.color_ramp.elements[1].color = (1.0, 0.9, 0.7, 1.0)    # z~0.5 (yellow-white)
    ...
    redshift_ramp.color_ramp.elements[3].color = (1.0, 0.5, 0.2, 1.0)    # z~4 (red-orange)
...
def create_lyman_alpha_forest_node_group():
    ...
    interface.new_socket(name="Base Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Redshift", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Absorption Lines", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Line Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Emission Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    absorption_ramp.color_ramp.elements[0].color = (0.1, 0.1, 0.1, 1.0)  # Dark absorption
...
def create_redshift_material(name: str, preset: str = "local_universe") -> bpy.types.Material:
    """
