...
def create_absorption_node_group():
    ...
    # Input sockets
    interface.new_socket(name="Base Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Absorption Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Absorption Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Roughness", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Metallic", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Transmission", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    # Volume absorption
    ng.links.new(input_node.outputs["Absorption Color"], volume_absorption.inputs["Color"])
    ng.links.new(input_node.outputs["Absorption Strength"], volume_absorption.inputs["Density"])
...
def create_atmospheric_absorption_node_group():
    ...
    # Input sockets
    interface.new_socket(name="Atmosphere Color", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Density", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Scattering", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Absorption", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Anisotropy", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    ng.links.new(input_node.outputs["Atmosphere Color"], volume_absorption.inputs["Color"])
    ng.links.new(absorption_density.outputs["Value"], volume_absorption.inputs["Density"])
...
def create_absorption_material(name: str, preset: str = "dust_lane") -> bpy.types.Material:
    """
    ...
    # Connect nodes
    mat.node_tree.links.new(absorption_group.outputs["Shader"], output.inputs["Surface"])
