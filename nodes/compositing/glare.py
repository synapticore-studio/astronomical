...
def create_stellar_glare_node_group():
    ...
    interface.new_socket(name="Glare Threshold", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Glare Mix", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Streaks", in_out='INPUT', socket_type='NodeSocketInt')
    interface.new_socket(name="Streak Length", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Fade", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Angle Offset", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_airy_disk_node_group():
    ...
    # Input-Sockets
    interface.new_socket(name="Image", in_out='INPUT', socket_type='NodeSocketColor')
    interface.new_socket(name="Star Threshold", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Telescope Diameter", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Wavelength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Airy Intensity", in_out='INPUT', socket_type='NodeSocketFloat')
...
def create_atmospheric_turbulence_node_group():
    ...
    interface.new_socket(name="Turbulence Strength", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Scintillation", in_out='INPUT', socket_type='NodeSocketFloat')
...
def apply_glare_preset(compositor: bpy.types.CompositorNodeTree, telescope_type: str) -> None:
