...
def create_cosmic_filament_node_group():
    ...
    interface.new_socket(name="Filament Count", in_out='INPUT', socket_type='NodeSocketInt')
    interface.new_socket(name="Filament Length", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Filament Width", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Curvature", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Branch Factor", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Density Variation", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Random Seed", in_out='INPUT', socket_type='NodeSocketInt')
    ...
    ng.links.new(scale_distribution.outputs["Geometry"], set_smooth_dist.inputs["Geometry"])
    ng.links.new(set_smooth_dist.outputs["Geometry"], distribute_points.inputs["Mesh"])
    ng.links.new(input_node.outputs["Filament Count"], distribute_points.inputs["Density"])
    ...
    ng.links.new(instance_branches.outputs["Instances"], join_geometry.inputs["Geometry"])
    
    # Final instancing
    ng.links.new(join_geometry.outputs["Geometry"], instance_filaments.inputs["Instance"])
    ng.links.new(distribute_points.outputs["Points"], instance_filaments.inputs["Points"])
    ng.links.new(instance_filaments.outputs["Instances"], rotate_instances.inputs["Instances"])
    ...
    # Final output
    ng.links.new(rotate_instances.outputs["Instances"], set_smooth_final.inputs["Geometry"])
...
def create_galaxy_bridge_node_group():
    ...
    # Input sockets
    interface.new_socket(name="Start Position", in_out='INPUT', socket_type='NodeSocketVector')
    interface.new_socket(name="End Position", in_out='INPUT', socket_type='NodeSocketVector')
    interface.new_socket(name="Bridge Width", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Twist Factor", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Particle Density", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    ng.links.new(input_node.outputs["Particle Density"], distribute_particles.inputs["Density"])
    ng.links.new(particle_sphere.outputs["Mesh"], instance_particles.inputs["Instance"])
    ng.links.new(distribute_particles.outputs["Points"], instance_particles.inputs["Points"])
    ng.links.new(curve_to_mesh.outputs["Mesh"], join_geometry.inputs["Geometry"])
    ng.links.new(instance_particles.outputs["Instances"], join_geometry.inputs["Geometry"])
...
def get_galaxy_bridge_preset(preset_name: str) -> Dict[str, Any]:
    ...
    return GALAXY_BRIDGE_PRESETS.get(preset_name, GALAXY_BRIDGE_PRESETS["milky_way_andromeda"])
...
def create_galaxy_bridge_object(name: str, preset: str = "milky_way_andromeda") -> bpy.types.Object:
    """
