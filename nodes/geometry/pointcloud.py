...
def create_pointcloud_node_group():
    ...
    interface.new_socket(name="Point Count", in_out='INPUT', socket_type='NodeSocketInt')
    interface.new_socket(name="Point Size", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Distribution Radius", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Density Falloff", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    ng.links.new(set_smooth_point.outputs["Geometry"], instance_on_points.inputs["Instance"])
    
    # Instance setup
    ng.links.new(distribute_points.outputs["Points"], instance_on_points.inputs["Points"])
    ng.links.new(instance_on_points.outputs["Instances"], scale_instances.inputs["Instances"])
...
def create_stellar_pointcloud_node_group():
    ...
    interface.new_socket(name="Field Radius", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Magnitude Range", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Color Temperature", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Disk Thickness", in_out='INPUT', socket_type='NodeSocketFloat')
...
def get_stellar_pointcloud_preset(preset_name: str) -> Dict[str, Any]:
    ...
    return STELLAR_POINTCLOUD_PRESETS.get(preset_name, STELLAR_POINTCLOUD_PRESETS["local_neighborhood"])
...
def create_stellar_pointcloud_object(name: str, preset: str = "local_neighborhood") -> bpy.types.Object:
    """
