...
def create_spiral_galaxy_node_group():
    ...
    interface.new_socket(name="Galaxy Radius", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Number of Arms", in_out='INPUT', socket_type='NodeSocketInt')
    interface.new_socket(name="Arm Tightness", in_out='INPUT', socket_type='NodeSocketFloat')
    interface.new_socket(name="Central Bulge", in_out='INPUT', socket_type='NodeSocketFloat')
